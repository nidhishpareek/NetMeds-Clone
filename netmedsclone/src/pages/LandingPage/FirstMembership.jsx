    ...
    <Box borderTop='1px solid #dddde0' borderBottom='1px solid #dddde0' p='30px 0' m='0 25px 20px 25px'>
        <Grid gridTemplateColumns={'repeat(2,1fr)'}>
            <Flex>
                <Center>
                    <Box>
                        <Image src='https://www.netmeds.com/assets/gloryweb/images/icons/new-icons/netmeds_first_membership.svg'></Image>
                   </Box>
                </Center>
                <Box ml='30px'>
            ...
            <Flex ml='45%' alignItems={'center'} justifyContent='space-between'>
                <Box color={'#ef4281'} fontWeight='600'><i class="fa-solid fa-bolt"></i> Starting at ₹299</Box>
                <Box>
